...
class ExpertRegisterController extends GetxController {
  ...
  String? validateInputs() {
    ...
    if (organization.isEmpty) {
      return 'organization_required'.tr;
    }
    if (organization.length < 2) {
      return 'organization_min_length'.tr;
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData != null && responseData['status'] == "Success") {
          ...
          Get.snackbar(
            'success'.tr, 
            'registration_successful_otp'.tr,
            snackPosition: SnackPosition.BOTTOM,
          ...
          if (responseData['result'] != null && 
            ...
            // If OTP is generated, go to OTP verification screen
          ...
          Get.snackbar(
            ...
            responseData?['statusMessage'] ?? 'unknown_error'.tr,
            snackPosition: SnackPosition.BOTTOM,
            backgroundColor: Colors.red,
            colorText: Colors.white,
            duration: const Duration(seconds: 3),
