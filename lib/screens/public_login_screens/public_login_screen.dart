...
import 'package:bhooskhalann/screens/public_login_screens/public_login_controller.dart';
...
class PublicLoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(PublicLoginController());
